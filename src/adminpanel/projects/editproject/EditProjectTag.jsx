  ...
  return (
    <Box>
      <Box
        ...
        <Typography variant="h4"> Edit Project Tag</Typography>
        <Button
          variant="contained"
          color="success"
          onClick={handleProjectTagSubmit}>
          Save
        </Button>
      </Box>
      <Box
        ...
        <Box
          ...
          Active: <Switch color="warning" checked={formData.is_active} />
        </Box>
